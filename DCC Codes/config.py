...
def get_data_dir(db):
    ...
    """
    "path = '/content/drive/MyDrive/DCC-master/data/easy/'"
    "path = '/content/drive/MyDrive/DCC-master/data/tmd/'"
    path = '/content/drive/MyDrive/DCC-master/data/oyster/'
    return path
...
def get_output_dir(db):
    ...
    :return: path to data directory
    """
    "path = '/content/drive/MyDrive/DCC-master/data/easy/results/'"
    "path = '/content/drive/MyDrive/DCC-master/data/tmd/results/'"
    path = '/content/drive/MyDrive/DCC-master/data/oyster/results/'
    return path
