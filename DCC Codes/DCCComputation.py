...
def computeObj(U, pairs, _delta, gtlabels, numeval, X):
    ...
    ari, ami, nmi, acc, dbl = benchmarking(gtlabels[:numeval], labels[:numeval], features)

    return index2, ari, ami, nmi, acc, dbl, n_components, labels


def benchmarking(gtlabels, labels, features):
